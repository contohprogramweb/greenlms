...
class Konfigurasiperpustakaan_m extends MY_Model
{

    protected $_table_name  = 'konfigurasi_perpustakaan';
    protected $_primary_key = 'libraryconfigureID';
    protected $_order_by    = "libraryconfigureID desc";

    public $konfigurasi_perpustakaan = ['id_peran' => 0, 'max_issue_book' => 0, 'max_renewed_limit' => 0, 'per_renew_limit_day' => 0, 'book_fine_per_day' => 0, 'issue_off_limit_amount' => 0];
