...
class Pengaturanemail extends Admin_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Pengaturanemail_m');
    ...
    public function index()
    {
        ...
        $this->data['pengaturan_surel'] = (object) pluck($this->pengaturanemail_m->get_emailsetting(), 'optionvalue', 'optionkey');
        if ($_POST) {
            $rules = $this->rules();
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->pengaturanemail_m->insertorupdate_emailsetting($array);
