...
class Storebook extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$this->data['get_title'] = 'Kelola Buku Dijual | '.$this->data["generalsetting"]->sitename;
    ...
    public function add()
    {
		...
		$this->data['get_title'] = 'Tambah Buku Dijual | '.$this->data["generalsetting"]->sitename;
    ...
    {
        $storebookID = htmlentities(escapeString($this->uri->segment(3)));
		$this->data['get_title'] = 'Lihat Data Buku Dijual | '.$this->data["generalsetting"]->sitename;
