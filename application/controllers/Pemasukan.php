...
class Pemasukan extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['incomes'] = $this->pemasukan_m->get_income();
    ...
    public function add()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->pemasukan_m->insert_income($array);
    ...
    public function edit()
    {
        ...
        if ((int) $incomeID) {
            $pemasukan = $this->pemasukan_m->get_single_income(array('id_pemasukan' => $incomeID));
            if (calculate($pemasukan)) {
                ...
                if ($_POST) {
                    ...
                    if ($this->form_validation->run() == false) {
                        ...
                        $this->pemasukan_m->update_income($array, $incomeID);
                        $this->session->set_flashdata('success', 'Success');
                        redirect(base_url('pemasukan/index'));
                    }
                } else {
    ...
    public function delete()
    {
        ...
        if ((int) $incomeID) {
            $pemasukan = $this->pemasukan_m->get_single_income(array('id_pemasukan' => $incomeID));
            if (calculate($pemasukan)) {
                $this->pemasukan_m->delete_income($incomeID);
                $this->session->set_flashdata('success', 'Success');
                redirect(base_url('pemasukan/index'));
            } else {
                $this->data["subview"] = "_not_found";
