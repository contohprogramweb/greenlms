...
class Bukubarcodereport extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->data["subview"] = "laporan/Kodebatangbuku/index";
            } else {
    ...
    public function pdf()
    {
        ...
        if (((int) $bookcategoryID || $bookcategoryID == 0) && ((int) $bookID || $bookID == 0)) {
            ...
            $this->pdf->create(['stylesheet' => 'bookbarcodereport.css', 'view' => 'laporan/Kodebatangbuku/pdf.php', 'data' => $this->data]);
        } else {
    ...
    private function generatebarcode($buku, $bookitems)
    {
        if(!calculate($buku)) {
            ...
            redirect(base_url('Laporankodebatangbuku/index'));
        }
