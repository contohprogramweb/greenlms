...
class Pengaturansms extends Admin_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Pengaturansms_m');
    ...
    public function index()
    {
        ...
        $this->data['smssetting'] = (object) pluck($this->pengaturansms_m->get_smssetting(), 'optionvalue', 'optionkey');
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->pengaturansms_m->insertorupdate_smssetting($array);
                $this->session->set_flashdata('success', 'Success');
                redirect(base_url('Pengaturansms/index'));
            }
        } else {
            $this->data["subview"] = "smssetting/index";
            $this->load->view('_main_layout', $this->data);
