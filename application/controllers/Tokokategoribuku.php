...
class Toko_bukucategory extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['kategori_buku_toko'] = $this->tokokategoribuku_m->get_storebookcategory();
    ...
    public function add()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->tokokategoribuku_m->insert_storebookcategory($array);
    ...
    public function edit()
    {
        ...
        if ((int) $storebookcategoryID) {
            $this->data['kategori_buku_toko'] = $this->tokokategoribuku_m->get_single_storebookcategory(array('storebookcategoryID' => $storebookcategoryID));
            if (calculate($this->data['kategori_buku_toko'])) {
                if ($_POST) {
                    ...
                    if ($this->form_validation->run() == false) {
                        ...
                        $this->tokokategoribuku_m->update_storebookcategory($array, $storebookcategoryID);
                        $this->session->set_flashdata('success', 'Success');
                        redirect(base_url('kategori_buku_toko/index'));
                    }
                } else {
    ...
    public function delete()
    {
        $storebookcategoryID = htmlentities(escapeString($this->uri->segment(3)));
        if ((int) $storebookcategoryID) {
            $kategori_buku_toko = $this->tokokategoribuku_m->get_single_storebookcategory(array('storebookcategoryID' => $storebookcategoryID));
            if (calculate($kategori_buku_toko)) {
                ...
                $this->tokokategoribuku_m->delete_storebookcategory($storebookcategoryID);
                $this->session->set_flashdata('success', 'Success');
                redirect(base_url('kategori_buku_toko/index'));
            } else {
                $this->data["subview"] = "_not_found";
    ...
    public function check_unique_storebookcategory($name)
    {
        $storebookcategoryID = htmlentities(escapeString($this->uri->segment(3)));
        if ((int) $storebookcategoryID) {
            $kategori_buku_toko = $this->tokokategoribuku_m->get_single_storebookcategory(array('nama' => $name, 'storebookcategoryID !=' => $storebookcategoryID));
        } else {
            $kategori_buku_toko = $this->tokokategoribuku_m->get_single_storebookcategory(array('nama' => $name));
        }
        if (calculate($kategori_buku_toko)) {
