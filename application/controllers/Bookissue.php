...
class Bookissue extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$this->data['get_title'] = 'Kelola Peminjaman Buku | '.$this->data["generalsetting"]->sitename;
    ...
    public function add()
    {
		...
		$this->data['get_title'] = 'Tambah Peminjaman Buku | '.$this->data["generalsetting"]->sitename;
    ...
    public function edit()
    {
		...
		$this->data['get_title'] = 'Edit Peminjaman Buku | '.$this->data["generalsetting"]->sitename;
    ...
    public function view()
    {
		...
		$this->data['get_title'] = 'Lihat Data Peminjaman Buku | '.$this->data["generalsetting"]->sitename;
    ...
    public function renewandreturn()
    {
		...
		$this->data['get_title'] = 'Perpanjangan-Pengembalian  | '.$this->data["generalsetting"]->sitename;
