...
class Pembaruan extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($_FILES) {
            ...
            if ($this->form_validation->run() == false) {
                $this->data["subview"] = "pembaruan/index";
                                ...
                                if ($infos != '') {
                                    ...
                                    if ((strtolower($updateArr['database']) == 'yes') && !empty($updateArr['itemname'])) {
                                        ...
                                        if ($updateArr['versi'] != 'none') {
                                            ...
                                            $this->pembaruan_m->insert_update($array);
                                        }
                                    }
                ...
                redirect(base_url('Pembaruan/index'));
            }
        } else {
            $this->data["subview"] = "pembaruan/index";
            $this->load->view('_main_layout', $this->data);
