...
class Role extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$this->data['get_title'] = 'Kelola Hak Akses | '.$this->data["generalsetting"]->sitename;
    ...
    public function add()
    {
		$this->data['get_title'] = 'Tambah Hak Akses | '.$this->data["generalsetting"]->sitename;
    ...
    {
		$this->data['get_title'] = 'Edit Hak Akses | '.$this->data["generalsetting"]->sitename;
