...
class Akunsaya extends Beranda_Controller
{
    ...
    public function index()
    {
        ...
        $this->data["subview"] = "beranda/myaccount";
    ...
    public function login()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->data["subview"] = "beranda/login";
                $this->load->view('_frontend_layout', $this->data);
            } else {
                ...
                if (calculate($anggota) && $anggota->status == 1) {
                    ...
                    redirect(base_url('Akunsaya/index'));
    ...
    public function register()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                $this->data['errors']  = $this->form_validation->error_array();
                $this->data["subview"] = "beranda/register";
                $this->load->view('_frontend_layout', $this->data);
            } else {
    ...
    public function order()
    {
        ...
        $this->data['pesanan']  = $this->pesanan_m->get_order_by_order(['id_anggota' => $this->session->userdata('loginmemberID')]);
        $this->data["subview"] = "beranda/order";
        $this->load->view('_frontend_layout', $this->data);
    }
    ...
    public function orderview($orderID)
    {
        ...
        $this->data['order']      = $this->pesanan_m->get_single_order(['id_anggota' => $this->session->userdata('loginmemberID'), 'id_pesanan' => $orderID]);
        $this->data['anggota']     = $this->anggota_m->get_single_member(['id_anggota' => $this->session->userdata('loginmemberID')]);
        $this->data['item_pesanan'] = $this->itempesanan_m->get_order_by_orderitem_with_storebook(['id_pesanan' => $orderID]);
        $this->data["subview"]    = "beranda/orderview";
        $this->load->view('_frontend_layout', $this->data);
    }
}
