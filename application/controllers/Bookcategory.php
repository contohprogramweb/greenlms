...
class Bookcategory extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$this->data['get_title'] = 'Kelola Kategori Buku | '.$this->data["generalsetting"]->sitename;
    ...
    public function add()
    {
		...
		$this->data['get_title'] = 'Tambah Kategori Buku | '.$this->data["generalsetting"]->sitename;
        if ($_POST) {
            $rules = $this->rules();
    ...
    public function edit()
    {
		...
		$this->data['get_title'] = 'Edit Kategori Buku | '.$this->data["generalsetting"]->sitename;
