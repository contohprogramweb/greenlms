...
class Bookcategory extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['kategori_buku'] = $this->bookcategory_m->get_bookcategory();
    ...
    public function edit()
    {
        ...
        if ((int) $bookcategoryID) {
            $this->data['kategori_buku'] = $this->bookcategory_m->get_single_bookcategory(array('bookcategoryID' => $bookcategoryID));
    ...
    public function delete()
    {
        $bookcategoryID = htmlentities(escapeString($this->uri->segment(3)));
        if ((int) $bookcategoryID) {
            $kategori_buku = $this->bookcategory_m->get_single_bookcategory(array('bookcategoryID' => $bookcategoryID));
    ...
    public function check_unique_bookcategory($name)
    {
        $bookcategoryID = htmlentities(escapeString($this->uri->segment(3)));
        if ((int) $bookcategoryID) {
            $kategori_buku = $this->bookcategory_m->get_single_bookcategory(array('nama' => $name, 'bookcategoryID !=' => $bookcategoryID));
            if (calculate($kategori_buku)) {
            ...
            $kategori_buku = $this->bookcategory_m->get_single_bookcategory(array('nama' => $name));
            if (calculate($kategori_buku)) {
                $this->form_validation->set_message("check_unique_bookcategory", "The %s is already exits.");
                return false;
            }
