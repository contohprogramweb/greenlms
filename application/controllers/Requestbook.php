...
class Requestbook extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$this->data['get_title'] = 'Kelola Permintaan Buku | '.$this->data["generalsetting"]->sitename;
    ...
    public function add()
    {
		...
		$this->data['get_title'] = 'Tambah Permintaan Buku | '.$this->data["generalsetting"]->sitename;
    ...
    public function edit()
    {
		...
		$this->data['get_title'] = 'Edit Permintaan Buku | '.$this->data["generalsetting"]->sitename;
    ...
    {
        $requestbookID = htmlentities(escapeString($this->uri->segment(3)));
		$this->data['get_title'] = 'Lihat Data Permintaan Buku | '.$this->data["generalsetting"]->sitename;
