...
class Instalasi extends My_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('instalasi/index', $this->data);
    }
    ...
    public function purchase()
    {
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                $this->load->view('instalasi/purchase', $this->data);
            } else {
                redirect(base_url('Instalasi/database'));
            }
        } else {
            $this->load->view('instalasi/purchase', $this->data);
        }
    ...
    public function database()
    {
        if ($_POST) {
            ...
            $this->form_validation->set_rules($rules);
            if ($this->form_validation->run() == false) {
                $this->load->view('instalasi/database', $this->data);
            } else {
                redirect(base_url('Instalasi/setting'));
            }
        } else {
            $this->load->view('instalasi/database', $this->data);
        }
    ...
    public function setting()
    {
        if ($_POST) {
            ...
            $this->form_validation->set_rules($rules);
            if ($this->form_validation->run() == false) {
                $this->load->view('instalasi/setting', $this->data);
            } else {
                $array                    = [];
                ...
                $this->pengaturanumum_m->insertorupdate_generalsetting($garray);
                ...
                redirect(base_url('Instalasi/complate'));
            }
        } else {
            $this->load->view('instalasi/setting', $this->data);
        }
    ...
    public function complate()
    {
        ...
        $this->load->view('instalasi/complate', $this->data);
    }
        ...
        if (strpos($this->input->post('database'), '.') === false) {
            ...
            if ($connected) {
                ...
                if ($this->dbutil->database_exists($this->db->database)) {
                    $this->instalasi_m->use_sql_string();
                    $id             = uniqid();
