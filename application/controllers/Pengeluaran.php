...
class Pengeluaran extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['expenses'] = $this->pengeluaran_m->get_order_by_expense();
    ...
    public function add()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->pengeluaran_m->insert_expense($array);
    ...
    public function edit()
    {
        ...
        if ((int) $expenseID) {
            $pengeluaran = $this->pengeluaran_m->get_single_expense(array('id_pengeluaran' => $expenseID));
            if (calculate($pengeluaran)) {
                ...
                if ($_POST) {
                    ...
                    if ($this->form_validation->run() == false) {
                        ...
                        $this->pengeluaran_m->update_expense($array, $expenseID);
                        $this->session->set_flashdata('success', 'Success');
                        redirect(base_url('pengeluaran/index'));
                    }
                } else {
    ...
    public function delete()
    {
        ...
        if ((int) $expenseID) {
            $pengeluaran = $this->pengeluaran_m->get_single_expense(array('id_pengeluaran' => $expenseID));
            if (calculate($pengeluaran)) {
                $this->pengeluaran_m->delete_expense($expenseID);
                $this->session->set_flashdata('success', 'Success');
                redirect(base_url('pengeluaran/index'));
            } else {
                $this->data["subview"] = "_not_found";
