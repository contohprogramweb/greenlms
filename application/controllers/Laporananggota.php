...
class Anggotareport extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->data["subview"] = "laporan/anggota/index";
    ...
    public function pdf()
    {
        ...
        if (((int) $roleID || $roleID == 0) && ((int) $memberID || $memberID == 0) && ((int) $bloodgroupID || $bloodgroupID == 0) && ((int) $status || $status == 0)) {
            ...
            $this->pdf->create(['stylesheet' => 'memberreport.css', 'view' => 'laporan/anggota/pdf.php', 'data' => $this->data]);
        } else {
