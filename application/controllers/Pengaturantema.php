...
class Pengaturantema extends Admin_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('Pengaturantema_m');
    ...
    public function index()
    {
        ...
        $this->data["subview"] = "pengaturantema/index";
    ...
    public function settheme()
    {
        if ($_POST) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $this->pengaturantema_m->insertorupdate_themesetting($array);
                $this->session->set_flashdata('success', 'Success');
            }
        } else {
            redirect(base_url('Pengaturantema/index'));
        }
