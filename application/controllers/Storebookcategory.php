...
class Storebookcategory extends Admin_Controller
{
    ...
    public function index()
    {
		...
		$this->data['get_title'] = 'Kelola Kategori Buku Dijual | '.$this->data["generalsetting"]->sitename;
    ...
    public function add()
    {
		...
		$this->data['get_title'] = 'Tambah Kategori Buku Dijual | '.$this->data["generalsetting"]->sitename;
    ...
    public function edit()
    {
		...
		$this->data['get_title'] = 'Edit Kategori Buku Dijual | '.$this->data["generalsetting"]->sitename;
