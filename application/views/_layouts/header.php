...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url('assets/Beranda/css/owl.carousel.min.css')?>" media="all" />
	<link rel="stylesheet" type="text/css" href="<?=base_url('assets/Beranda/css/owl.theme.default.min.css')?>" media="all" />
	...
	<link rel="stylesheet" href="<?=base_url('assets/Beranda/style.css')?>">
	<link rel="stylesheet" href="<?=base_url('assets/Beranda/css/responsive.css')?>">
	<script type="text/javascript" src="<?=base_url('assets/Beranda/js/jquery.min.js')?>"></script>
	<?php 
				...
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					<ul class="header-items">
						...
						<?php if($this->session->userdata('loggedin')) { ?>
							<li><a href="<?=base_url('Dasbor/index')?>" target="_blank"><i class="fa fa-dashboard"></i> Dashboard</a></li>
							<?php if (calculate($this->data["cart_contents"])) { ?>
								<li><a href="<?=base_url('Beranda/checkout')?>"><i class="fa fa-cart-arrow-down"></i> Checkout</a></li>
								<li><a href="<?=base_url('Beranda/cart')?>"><i class="fa fa-shopping-bag"></i> Chart (<?=$this->cart->total_items()?>)</a></li>
							<?php } ?>
							<li><a href="<?=base_url('Akunsaya/index')?>"><i class="fa fa-lock"></i> My Account</a></li>
							<li><a href="<?=base_url('Akunsaya/logout')?>"><i class="fa fa-sign-out"></i> Logout</a></li>
						<?php } else { ?>
							<li><a href="<?=base_url('Akunsaya/login')?>"><i class="fa fa-sign-in"></i> Login </a></li>
							<?php if($pengaturan_umum->registration) { ?>
								<li><a href="<?=base_url('Akunsaya/register')?>"><i class="fa fa-user-plus"></i> Daftar</a></li>
						<?php } } ?>
					</ul>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-4" style="margin-bottom:5px;">
					<div class="header-search">
						<form action="<?=base_url('Beranda/shop')?>" method="GET">
							    ...
							    if(calculate($cart_contents)) { foreach($cart_contents as $cart_content) { ?>
								    <div class="cart-item">
								        ...
								        <div class="cart-item-remove">
								            <a class="btn btn-danger btn-sm" href="<?=base_url('Beranda/removecart/'.$cart_content['rowid'])?>"><i class="fa fa-trash"></i></a>
								        </div>
								    </div>
								<?php } ?>
								    ...
								    <div class="mini-cart-footer">
							            <a class="btn btn-success btn-sm float-left" href="<?=base_url('Beranda/cart')?>">Lihat Keranjang</a>
							            <a class="btn btn-success btn-sm float-right" href="<?=base_url('Beranda/checkout')?>">Checkout</a>
								    </div>
								<?php } else { ?>
