                        ...
                        <div class="box-body">
                            <div class="form-group <?=form_error('id_peran') ? 'has-error' : ''?>">
                                ...
                                <?php 
                                    ...
                                    echo form_dropdown('id_peran', $roleArray,set_value('id_peran', $konfigurasi_perpustakaan->id_peran),'id='id_peran' class="form-control"');
                                ?>
                                <?=form_error('id_peran')?>
                            </div>
                            <div class="form-group <?=form_error('max_issue_book') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" value="<?=set_value('max_issue_book', $konfigurasi_perpustakaan->max_issue_book)?>" id="max_issue_book" name="max_issue_book"/>
                            ...
                            <div class="form-group <?=form_error('max_renewed_limit') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" value="<?=set_value('max_renewed_limit', $konfigurasi_perpustakaan->max_renewed_limit)?>" id="max_renewed_limit" name="max_renewed_limit"/>
                            ...
                            <div class="form-group <?=form_error('per_renew_limit_day') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" value="<?=set_value('per_renew_limit_day', $konfigurasi_perpustakaan->per_renew_limit_day)?>" id="per_renew_limit_day" name="per_renew_limit_day"/>
                            ...
                            <div class="form-group <?=form_error('book_fine_per_day') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" value="<?=set_value('book_fine_per_day', $konfigurasi_perpustakaan->book_fine_per_day)?>" id="book_fine_per_day" name="book_fine_per_day"/>
