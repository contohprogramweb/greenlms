<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-mytheme">
            <div class="box-body">
                <form method="POST" action="<?=base_url('Laporankodebatangbuku/index')?>">
                    <div class="row">
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php if($flag) { ?>
                                    ...
                                    <a href="<?=base_url('Laporankodebatangbuku/pdf/'.$bookcategoryID.'/'.$bookID)?>" class="btn btn-mytheme divhide" style="margin-top: 23px" target="_blank">PDF</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12" id="printDiv">
                            <?php $this->load->view('laporan/Kodebatangbuku/view')?>
                        </div>
                    </div>
                </div>
            </div>
