...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?=base_url('assets/Beranda/css/font-awesome.min.css')?>" media="all" />
                    ...
                    <div class="col-sm-10 col-sm-offset-1 ">
                        <div class="wizard">
                            <div class="wizard-inner">
                                ...
                                <?php $this->load->view('instalasi/tabitem')?>
                            </div>
                            ...
                            <div class="tab-content wizard-tabcontent">
                                <div class="tab-pane active" id="checklist">
                                    ...
                                    <ul class="list-inline pull-right">
                                        <li><a href="<?=(calculate($errors)) ? '#' : base_url('Instalasi/purchase') ?>" class="btn btn-primary" <?=(calculate($errors)) ? 'disabled': ''?>>Save and continue</a></li>
                                    </ul>
                                </div>
