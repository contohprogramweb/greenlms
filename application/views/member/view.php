                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="profile_view_item">
                                        <p><b>Status</b>: <span class="text-danger text-bold"><?=($member->status == 0) ? 'Pending' : (($member->status == 1) ? 'Aktif' : 'Non Aktif') ?></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="Aksi">
                                                        ...
                                                        <?php if($bookissue->status == 0) { ?>
                                                            <a href="<?=base_url('bookissue/renewandreturn/'.$bookissue->bookissueID)?>" class="btn btn-info btn-xs mrg" data-placement="auto" data-toggle="tooltip" data-original-title="Perpanjangan / Kembali"><i class="fa fa-retweet"></i></a>
                                                        <?php } ?>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
