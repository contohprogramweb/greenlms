                    ...
                    <div class="col-lg-7">
                        <div class="product-thumbnail-description">
                            ...
                            <div class="product-quantity">
                                <form action="<?=base_url('Beranda/addcart/'.$buku_toko->storebookID)?>" method="POST">
                            ...
                            <div class="social-sharing">
                                <ul>
                                    <li>Share :</li>
                                    <li>
                                        <a href="http://www.facebook.com/sharer.php?href=<?=base_url('Beranda/single/'.$buku_toko->storebookID)?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    </li>
                                    <li>
                                        <a href="http://twitter.com/share?url=<?=base_url('Beranda/single/'.$buku_toko->storebookID)?>&text=<?=$buku_toko->nama?>&hashtags=greenlms" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
