            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class='aktif'><a href="#profile" data-toggle="tab">Profile</a></li>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-title="Aksi">
                                                        ...
                                                        <?php if($peminjaman_buku->status == 0) { ?>
                                                            <a href="<?=base_url('peminjaman_buku/renewandreturn/'.$peminjaman_buku->bookissueID)?>" class="btn btn-info btn-xs mrg" data-placement="auto" data-toggle="tooltip" data-original-title="Perpanjang / Kembali"><i class="fa fa-retweet"></i></a>
                                                        <?php } ?>
                                                    </td>
                                                    <?php } ?>
                                                </tr>
