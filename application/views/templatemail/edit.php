                    ...
                    <form peran="form" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group <?=form_error('nama') ? 'has-error' : ''?>">
                                ...
                                <input type="text" class="form-control" value="<?=set_value('nama', $templat_surel->nama)?>" id='nama' name='nama'/>
                                <?=form_error('nama')?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name='templat' id='templat' cols="30" class="form-control"><?=set_value('templat',$templat_surel->templat)?></textarea>
                            ...
                            <div class="form-group <?=form_error('status') ? 'has-error' : ''?>">
                                ...
                                <?php 
                                    ...
                                    echo form_dropdown('status', $statusArray, set_value('status', $templat_surel->status) , 'class="form-control"'); 
                                ?>
                                <?=form_error('status')?>
                            </div>
                        </div>
